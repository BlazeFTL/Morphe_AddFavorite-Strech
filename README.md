...
A simple, user-friendly script to customize your Morphe Manager build. It adds a highly requested "Favorite Patches" feature and allows the app to be installed right alongside the official version.
